...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="container-lg nav-header-container">
                    <div class="col-auto col-sm-6 col-lg-2 me-auto ps-lg-0">
                        <a class="navbar-brand" href="/">
                            <img src="{{ asset('assets/frontends/images/logo-white.png') }}" data-at2x="images/logo-white@2x.png" class="default-logo" alt="">
            ...
            <div class="container">
                <div class="row align-items-stretch justify-content-center small-screen">
                    <div class="col-12 col-xl-6 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                        <h1 class="alt-font text-white opacity-6 margin-20px-bottom">Our business process</h1>
                        <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom">we provide high quality services</h2>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 position-relative mx-lg-auto overlap-gap-section sm-margin-30px-bottom">
                        <div class="d-flex align-items-center alt-font text-extra-medium font-weight-500 margin-30px-bottom">
                            <span class="flex-shrink-0 w-30px h-1px bg-fast-blue margin-20px-right"></span>
                            <div class="flex-grow-1 text-fast-blue">Walking is the best possible exercise</div>
                        </div>
                        <h5 class="alt-font font-weight-500 text-extra-dark-gray m-0">Litho specializes in strategy, creativity design and innovative technology build.</h5>
                    </div>
                    <div class="col-12 col-lg-5 mx-lg-auto col-md-6 position-relative overlap-gap-section">
                        <p class="w-90">Lorem ipsum dolor sit amet, consectetur adipiscing elit do eiusmod tempor incididunt ut labore et dolore magna Ut enim ad minim veniam, nostrud exercitation.</p>
            ...
            <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-8 md-margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn">
                            <div class="feature-box text-start h-100 feature-box-dark-hover box-shadow-small border-radius-5px bg-white overflow-hidden padding-4-rem-all">
                                ...
                                <div class="feature-box-content">
                                    <span class="alt-font font-weight-500 margin-10px-bottom d-block text-extra-dark-gray text-extra-medium">Consulting services</span>
                                    <p>Lorem ipsum is simply dummy text of the printing and typesetting industry lorem ipsum text</p>
                                    <a href="our-story.html" class="btn btn-extra-large btn-link text-extra-dark-gray">Read more</a>
                                </div>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-8 md-margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                            <div class="feature-box text-start h-100 feature-box-dark-hover box-shadow-small border-radius-5px bg-white overflow-hidden padding-4-rem-all">
                                ...
                                <div class="feature-box-content">
                                    <span class="alt-font font-weight-500 margin-10px-bottom d-block text-extra-dark-gray text-extra-medium">Digital marketing</span>
                                    <p>Lorem ipsum is simply dummy text of the printing and typesetting industry lorem ipsum text</p>
                                    <a href="our-story.html" class="btn btn-extra-large btn-link text-extra-dark-gray">Read more</a>
                                </div>
                                <div class="feature-box-overlay bg-fast-blue"></div>
                        ...
                        <div class="col-12 col-lg-4 col-md-6 col-sm-8 wow animate__fadeIn" data-wow-delay="0.4s">
                            <div class="feature-box text-start h-100 feature-box-dark-hover box-shadow-small border-radius-5px bg-white overflow-hidden padding-4-rem-all">
                                ...
                                <div class="feature-box-content">
                                    <span class="alt-font font-weight-500 margin-10px-bottom d-block text-extra-dark-gray text-extra-medium">Branding identity</span>
                                    <p>Lorem ipsum is simply dummy text of the printing and typesetting industry lorem ipsum text</p>
                                    <a href="our-story.html" class="btn btn-extra-large btn-link text-extra-dark-gray">Read more</a>
                                </div>
                                <div class="feature-box-overlay bg-fast-blue"></div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-4 offset-lg-1 d-flex flex-column flex-md-row align-items-center sm-margin-20px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                        ...
                        <h2 class="vertical-counter d-inline-flex font-weight-600 letter-spacing-minus-1px text-extra-dark-gray md-letter-spacing-normal mb-0" data-to="3650"></h2>
                    </div>
                    <div class="col-12 col-lg-6 col-sm-8 text-center wow animate__fadeIn" data-wow-delay="0.4s">
                        <h6 class="alt-font font-weight-500 text-extra-dark-gray text-center text-md-start d-inline-block w-90 mb-0 md-w-100">We started this company 10 years ago out of a desire to design and things.</h6>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6 position-relative margin-70px-top lg-margin-30px-top md-margin-50px-bottom">
                        <div class="w-70 border-radius-6px overflow-hidden position-relative">
                            <img src="https://via.placeholder.com/800x945" alt="" />
                        ...
                        <div class="position-absolute right-15px bottom-0px w-70" data-parallax-layout-ratio="1.1">
                            <img class="border-radius-6px" src="https://via.placeholder.com/800x945" alt="" />
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-5 col-sm-8 text-center margin-6-rem-bottom sm-margin-3-rem-bottom">
                        <span class="alt-font text-extra-medium margin-20px-bottom d-block text-fast-blue font-weight-500">Simple work process</span>
                        <h5 class="alt-font text-extra-dark-gray font-weight-500 d-inline-block">We provide high quality and cost effective services</h5>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
                    ...
                    <div class="col text-center process-step-style-01 last-paragraph-no-margin md-margin-50px-bottom wow animate__fadeIn">
                        <div class="process-step-icon-box margin-40px-bottom sm-margin-30px-bottom">
                            ...
                            <div class="process-step-icon bg-white"><i class="line-icon-Idea-5 icon-large text-gradient-light-purple-light-orange"></i></div>
                        </div>
                        <span class="alt-font d-block font-weight-500 text-extra-dark-gray margin-10px-bottom">Project Research</span>
                        <p class="w-85 d-inline-block lg-w-100 md-w-70 sm-w-90">Lorem ipsum is simply dummy text the printing industry</p>
                    </div>
                    ...
                    <div class="col text-center process-step-style-01 last-paragraph-no-margin md-margin-50px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="process-step-icon-box margin-40px-bottom sm-margin-30px-bottom">
                            ...
                            <div class="process-step-icon bg-white"><i class="line-icon-Fountain-Pen icon-large text-gradient-light-purple-light-orange"></i></div>
                        </div>
                        <span class="alt-font d-block font-weight-500 text-extra-dark-gray margin-10px-bottom">Design Sketches</span>
                        <p class="w-85 d-inline-block lg-w-100 md-w-70 sm-w-90">Lorem ipsum is simply dummy text the printing industry</p>
                    </div>
                    <!-- end process step item -->
                    <!-- start process step item -->
                    <div class="col text-center process-step-style-01 last-paragraph-no-margin xs-margin-50px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="process-step-icon-box margin-40px-bottom sm-margin-30px-bottom">
                            <span class="process-step-bfr bg-dark-gray w-80px h-1px opacity-2 d-none d-sm-block"></span>
                            <div class="process-step-icon bg-white"><i class="line-icon-Loading-2 icon-large text-gradient-light-purple-light-orange"></i></div>
                        </div>
                        <span class="alt-font d-block font-weight-500 text-extra-dark-gray margin-10px-bottom">Selected Concept</span>
                        <p class="w-85 d-inline-block lg-w-100 md-w-70 sm-w-90">Lorem ipsum is simply dummy text the printing industry</p>
                    </div>
                    <!-- end process step item -->
                    <!-- start process step item -->
                    <div class="col text-center process-step-style-01 last-paragraph-no-margin wow animate__fadeIn" data-wow-delay="0.6s">
                        <div class="process-step-icon-box margin-40px-bottom sm-margin-30px-bottom">
                            ...
                            <div class="process-step-icon bg-white"><i class="line-icon-Juice icon-large text-gradient-light-purple-light-orange"></i></div>
                        </div>
                        <span class="alt-font d-block font-weight-500 text-extra-dark-gray margin-10px-bottom">Client Presentation</span>
                        <p class="w-85 d-inline-block lg-w-100 md-w-70 sm-w-90">Lorem ipsum is simply dummy text the printing industry</p>
                    </div>
                    <!-- end process step item -->
                </div>
                <div class="row">
                    <div class="col text-center margin-8-rem-top lg-margin-6-half-rem-top">
                        <a href="contact-us-modern.html" class="btn btn-large btn-white btn-box-shadow">Get started now</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6 md-margin-50px-bottom wow animate__fadeInLeft" data-wow-delay="0.4s">
                        <div class="outside-box-left text-end">
                            <img src="images/our-process-03.png" alt="our process03" />
                        </div>
                    </div>
                    <div class="col-12 col-lg-5 offset-lg-1">
                        <h5 class="alt-font font-weight-500 text-extra-dark-gray margin-50px-bottom xs-margin-30px-bottom">We are expert in search engine and social media optimization</h5>
                        <!-- start feature box item -->
                        <div class="alt-font font-weight-500 d-inline-block text-extra-medium margin-15px-bottom"><span class="w-30px h-1px d-inline-block align-middle bg-fast-blue margin-15px-right"></span><span class="text-fast-blue d-inline-block">Unique designs</span></div>
                        <p class="w-75 lg-w-95">Lorem ipsum dolor sit amet, consectetur adipiscing do eiusmod tempor incididunt labore et dolore ut enim ad minim veniam nostrud.</p>
                        <!-- end feature box item -->
                        <!-- start feature box item -->
                        <div class="alt-font font-weight-500 d-inline-block text-extra-medium margin-15px-bottom margin-20px-top"><span class="w-30px h-1px d-inline-block align-middle bg-fast-blue margin-15px-right"></span><span class="text-fast-blue d-inline-block">Creative concept designs</span></div>
                        <p class="w-75 lg-w-95">Lorem ipsum dolor sit amet, consectetur adipiscing do eiusmod tempor incididunt labore et dolore ut enim ad minim veniam nostrud.</p>
                        <!-- end feature box item -->
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-6 padding-8-half-rem-all lg-padding-5-half-rem-all xs-padding-15px-lr" style="background: url('images/our-process-bg-4.png') no-repeat top -45px left;">
                        <h5 class="alt-font font-weight-500 text-white margin-4-rem-bottom ">Don't miss this amazing big events conference and opportunities!</h5>
                                ...
                                <div class="panel-heading border-color-white-transparent active-accordion">
                                    <a class="accordion-toggle" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#collapseOne">
                                        <div class="panel-title">
                                            <span class="alt-font text-white d-inline-block">What do you mean by item and end product?</span>
                            ...
                            <div class="panel bg-transparent">
                                <div class="panel-heading border-color-white-transparent">
                                    <a class="accordion-toggle" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#collapseTwo">
                                        <div class="panel-title">
                                            <span class="alt-font text-white d-inline-block">What are some examples of permitted end products?</span>
                            ...
                            <div class="panel bg-transparent">
                                <div class="panel-heading border-color-white-transparent">
                                    <a class="accordion-toggle" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#collapseThree">
                                        <div class="panel-title">
                                            <span class="alt-font text-white d-inline-block">Am i allowed to modify the item that i purchased?</span>
                                            <i class="indicator text-white feather icon-feather-plus"></i>
                                        </div>
                                    </a>
                                </div>
                    ...
                    <div class="col-12 col-lg-6 cover-background md-h-550px sm-h-400px xs-h-300px" style="background-image: url('https://via.placeholder.com/1890x1345');">
        ...
        <section class="wow animate__fadeIn">
            <div class="container">
                <div class="row row-cols-1 row-cols-md-4 row-cols-sm-2 client-logo-style-03">
                    <!-- start client item -->
                    <div class="col text-center wow animate__fadeIn" data-wow-delay="0.2s">
                        <a href="#"><img src="https://via.placeholder.com/400x160" alt=""/></a>
                    </div>
                    <!-- end client item -->
                    <!-- start client item -->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-5 col-lg-6 col-sm-8 text-center margin-6-rem-bottom md-margin-5-rem-bottom sm-margin-3-rem-bottom">
                        <span class="alt-font text-extra-medium margin-20px-bottom d-block text-fast-blue font-weight-500">What people say</span>
                        <h5 class="alt-font text-extra-dark-gray font-weight-500">Perfect design and code delivered for your projects</h5>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonials-style-02 border-radius-5px overflow-hidden">
                                        <img alt="" class="d-inline-block" src="https://via.placeholder.com/800x580">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonials-style-02 border-radius-5px overflow-hidden">
                                        ...
                                        <div class="testimonials-content padding-3-half-rem-all text-center bg-white lg-padding-2-half-rem-lr">
                                            ...
                                            <p>Lorem ipsum dolor amet consectetur do eiusmod tempor incididunt labore ut enim ad minim veniam</p>
                                            <span class="alt-font font-weight-500 text-extra-dark-gray text-uppercase d-block">William Smith</span>
                                            <span class="alt-font font-weight-500 text-small text-uppercase d-block">Creative head</span>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="parallax wow animate__fadeIn" data-parallax-background-ratio="0.2" style="background-image:url('https://via.placeholder.com/1920x1100');">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-xl-5 col-md-4 position-relative text-center text-md-end">
                        <a href="index.html" class="btn btn-large btn-gradient-light-purple-light-orange">Download litho</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-12 col-lg-3 col-sm-6">
                            ...
                            <div class="w-100 d-inline-block margin-10px-top">
                                <ul class="instafeed-grid instafeed-wrapper grid grid-3col xl-grid-3col lg-grid-3col md-grid-3col sm-grid-3col xs-grid-3col gutter-small" data-total="3">
                                    <li class="grid-item"><figure><a href="#" target="_blank"><img src="#"  class="insta-image" alt="" /><span class="insta-counts"><i class="fab fa-instagram"></i></span></a></figure></li>
                                </ul>

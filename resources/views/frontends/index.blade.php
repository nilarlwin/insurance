...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="container-fluid nav-header-container">
                    <div class="col-6 col-lg-2 me-auto ps-lg-0">
                        <a class="navbar-brand" href="/">
                            <img src="{{ asset('assets/frontends/images/logo-gradient-sky-blue-pink.png') }}" data-at2x="images/logo-gradient-sky-blue-pink@2x.png" class="default-logo" alt="">
                            <img src="{{ asset('assets/frontends/images/logo-black.png') }}" data-at2x="images/logo-black@2x.png" class="alt-logo" alt="">
                            <img src="{{ asset('assets/frontends/images/logo-gradient-sky-blue-pink.png') }}" data-at2x="images/logo-gradient-sky-blue-pink@2x.png" class="mobile-logo" alt="">
                        </a>
                    </div>
        ...
        <!-- end scroll to top -->
        <!-- javascript -->
        <script type="text/javascript" src="{{ asset('assests/frontends/js/jquery.min.js') }}"></script>
